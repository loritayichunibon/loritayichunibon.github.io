...
$(function() {
    $('.searchProductList .buttonBlock').on('click', function() {
        $('.addSearchProductList').fadeToggle().removeClass("addSearchProductList");
    });
});

$(function() {
    $('.searchPageList .buttonBlock').on('click', function() {
        $('.addSearchPageList').fadeToggle().removeClass("addSearchPageList");
    });
});